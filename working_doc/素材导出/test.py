...
folder_path = 'D:\\CS\\Logic-studying\\Jack-Frost\\working_doc\\素材导出\\sprites\\蓝色跳跃'
...
# 使用方法: 指定文件夹路径和前缀字符串
rename_files_in_directory("D:\\CS\\Logic-studying\\Jack-Frost\\working_doc\\素材导出\\sprites\\蓝色跳跃", "")
